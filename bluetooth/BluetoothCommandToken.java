 ...
 *
 */
public class BluetoothCommandToken extends Token {

    public BluetoothCommandToken(BluetoothCommands command){
        this._command = command;
    }
    
    public BluetoothCommands getCommandValue(){
    ...
    public BooleanToken isEqualTo(Token rightArgument)
            throws IllegalActionException {
        if (rightArgument instanceof BluetoothCommandToken){
            BluetoothCommandToken right = (BluetoothCommandToken) rightArgument;
            ...
            throw new IllegalActionException("The argument must be of type BluetoothCommandToken");
        }
    }
    ...
    private final BluetoothCommands _command;
